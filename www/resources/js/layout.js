(function () {
    "use strict";
    if (sessionStorage.getItem("blocker") === "hidepopUp") {
        alert("hello");
        // $(".blocker").hide();
    }
    if (sessionStorage.getItem("defaultAttribute")) {
        ...
        if (
            ...
            JSON.stringify(CurrentLayoutAttributes)
        ) {
            ...
            isLayoutAttributes["data-layout-direction"] =
                sessionStorage.getItem("data-layout-direction");
