(function () {
            ...
            Array.from(collapses).forEach(function (collapse) {
                ...
                collapse.addEventListener("show.bs.collapse", function (e) {
                    ...
                    if (closestCollapse) {
                        ...
                        Array.from(siblingCollapses).forEach(function (
                            siblingCollapse
                        ) {
                ...
                collapse.addEventListener("hide.bs.collapse", function (e) {
                    ...
                    Array.from(childCollapses).forEach(function (
                        childCollapse
                    ) {
    ...
    function twoColumnMenuGenerate() {
        ...
        if (
            ...
            Array.from(
                ...
                if (
                    item.parentElement.classList.contains("twocolumn-item-show")
                ) {
            ...
            if (currentPath) {
                ...
                if (a) {
                    var parentCollapseDiv = a.closest(
            ...
            Array.from(
                ...
                element.addEventListener("click", function (e) {
                    if (
                        !(
                            currentPath == "/" + element.getAttribute("href") &&
                    ...
                    if (
                        ...
                        var twoColumnItem = document.getElementsByClassName(
                            "twocolumn-item-show"
                        );

                        twoColumnItem.length > 0
                            ? twoColumnItem[0].classList.remove(
                                  "twocolumn-item-show"
                              )
                            : "";

                        var currentMenu = e.target.matches("i")
                            ? e.target.closest("a")
                            : e.target;
                        var childMenusId = currentMenu
                            .getAttribute("href")
                            .slice(1);
                        if (document.getElementById(childMenusId))
                            document
                                .getElementById(childMenusId)
    ...
    function menuItem(e) {
        if (e.target && e.target.matches("a.nav-link span")) {
            if (
                elementInViewport(e.target.parentElement.nextElementSibling) ==
                false
            ) {
                ...
                Array.from(eleChild.querySelectorAll(".menu-dropdown")).forEach(
                    function (item) {
                ...
                switch (isLayoutAttributes["data-layout"]) {
                    ...
                    default:
                        if (
                            ...
                            sessionStorage.getItem("data-layout") == "twocolumn"
                        ) {
                            getElementUsingTagname("data-layout", "twocolumn");
                            sessionStorage.setItem("data-layout", "twocolumn");
                            document.documentElement.setAttribute(
                ...
                switch (isLayoutAttributes["data-sidebar-size"]) {
                    ...
                    default:
                        if (
                            ...
                            sessionStorage.getItem("data-sidebar-size") == "md"
                        ) {
                            document.documentElement.setAttribute(
                                "data-sidebar-size",
                                "md"
                ...
                switch (isLayoutAttributes["data-layout-mode"]) {
                    ...
                    default:
                        if (
                            ...
                            sessionStorage.getItem("data-layout-mode") == "dark"
                        ) {
                            sessionStorage.setItem("data-layout-mode", "dark");
                            document.documentElement.setAttribute(
                                "data-layout-mode",
                ...
                switch (isLayoutAttributes["data-sidebar"]) {
                    ...
                    default:
                        if (
                            ...
                            sessionStorage.getItem("data-sidebar") == "dark"
                        ) {
                            sessionStorage.setItem("data-sidebar", "dark");
                            getElementUsingTagname("data-sidebar", "dark");
                            document.documentElement.setAttribute(
                            ...
                            sessionStorage.getItem("data-sidebar") == "gradient"
                        ) {
                            sessionStorage.setItem("data-sidebar", "gradient");
                            getElementUsingTagname("data-sidebar", "gradient");
                            document.documentElement.setAttribute(
                ...
                switch (isLayoutAttributes["data-preloader"]) {
                    ...
                    default:
                        if (
                            ...
                            sessionStorage.getItem("data-preloader") == "enable"
                        ) {
                            getElementUsingTagname("data-preloader", "enable");
                            sessionStorage.setItem("data-preloader", "enable");
                            document.documentElement.setAttribute(
                ...
                switch (isLayoutAttributes["data-body-image"]) {
                    ...
                    default:
                        if (
                            ...
                            sessionStorage.getItem("data-body-image") == "img-2"
                        ) {
                            sessionStorage.setItem("data-body-image", "img-2");
                            getElementUsingTagname("data-body-image", "img-2");
                            document.documentElement.setAttribute(
                            ...
                            sessionStorage.getItem("data-body-image") == "img-3"
                        ) {
                            sessionStorage.setItem("data-body-image", "img-3");
                            getElementUsingTagname("data-body-image", "img-3");
                            document.documentElement.setAttribute(
                            ...
                            sessionStorage.getItem("data-body-image") == "none"
                        ) {
                            sessionStorage.setItem("data-body-image", "none");
                            getElementUsingTagname("data-body-image", "none");
                            document.documentElement.setAttribute(
    ...
    function getElementUsingTagname(ele, val) {
        Array.from(
            document.querySelectorAll("input[name=" + ele + "]")
        ).forEach(function (x) {
    ...
    function setDefaultAttribute() {
        if (!sessionStorage.getItem("defaultAttribute")) {
            ...
            sessionStorage.setItem(
                "defaultAttribute",
                JSON.stringify(isLayoutAttributes)
            );
            ...
            var isLayoutAttributes = {};
            isLayoutAttributes["data-layout"] =
                sessionStorage.getItem("data-layout");
            isLayoutAttributes["data-sidebar-size"] =
                sessionStorage.getItem("data-sidebar-size");
            isLayoutAttributes["data-layout-mode"] =
                sessionStorage.getItem("data-layout-mode");
            isLayoutAttributes["data-layout-width"] =
                sessionStorage.getItem("data-layout-width");
            isLayoutAttributes["data-sidebar"] =
                sessionStorage.getItem("data-sidebar");
            isLayoutAttributes["data-sidebar-image"] =
                sessionStorage.getItem("data-sidebar-image");
            isLayoutAttributes["data-layout-position"] = sessionStorage.getItem(
                "data-layout-position"
            );
            isLayoutAttributes["data-layout-style"] =
                sessionStorage.getItem("data-layout-style");
            isLayoutAttributes["data-topbar"] =
                sessionStorage.getItem("data-topbar");
            isLayoutAttributes["data-preloader"] =
                sessionStorage.getItem("data-preloader");
            isLayoutAttributes["data-body-image"] =
                sessionStorage.getItem("data-body-image");
            layoutSwitch(isLayoutAttributes);
        }
    }
    ...
    function initModeSetting() {
        ...
        if (lightDarkBtn && lightDarkBtn.length) {
            lightDarkBtn[0].addEventListener("click", function (event) {
                html.hasAttribute("data-layout-mode") &&
                html.getAttribute("data-layout-mode") == "dark"
                    ? setLayoutMode(
                          "data-layout-mode",
                          "light",
                          "layout-mode-light",
