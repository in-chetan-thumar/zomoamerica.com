...
@section('main')
    ...
    <div class="row linha-das-categorias-classic-line">
        ...
        <div class="row" style="margin-top:-150px;text-align:center;">
            <div class="col-sm-6 titulo-descr-categorias-classic-line">
                ...
                @elseif($category_id ===  "Max-line")
                    <div class="elementor-widget-container elementor-motion-effects-element" style="transform: rotateX(var(--rotateX))rotateY(var(--rotateY)); --rotateX: -9.80769230769231deg; --rotateY: -9.882869692532944deg">
                        <img width="523"class="image" height="336" src="{{ asset('assets/frontend/images/flavors/zomo_max.png')}}"sizes="(max-width: 523px) 100vw, 523px">
                    </div>
                @endif
            </div>
            <div class="col-sm-4" style="letter-spacing: 2px;">
                ...
                <div class="col-sm-4 zomo_max-quality">
                    <img width="459" height="167"  src="{{ asset('assets/frontend/images/flavors/max_quality.png')}}"sizes="(max-width: 459px) 100vw, 459px">
                </div>
                @endif      
        </div>  
    </div>
    ...
    <div class="new-container max-line" style="margin-top: 400px;">
       <div class="row">
            <h2 class="title-main"><p>MAXIMUM TASTE,</p><p> QUALITY AND LAST LONGER.</p></h2>
            <div class="col-sm-2">
                <img width="459" height="167"  src="{{ asset('assets/frontend/images/flavors/max.png')}}"sizes="(max-width: 459px) 100vw, 459px">

            </div>
            <div class="col-sm-8">
            <p class="inner_paragraph">Find a unique experience with a new concept that brings the highest quality to your session. From the selection of the best tobacco imported directly from Germany to the ISO 9001 international certification in every production process, every detail has been very well taken care of to guarantee maximum satisfaction at all times.</p>
            <br><br>
            <p class="inner_paragraph"><span style="color: var( --e-global-color-text ); letter-spacing: 0.4px;">
                We are always improving ourselves and looking for the best of the best for you, that’s why Zomo Max meets the highest quality standards. We use specially selected and tested international flavorings, in addition to a new quality process developed in the United States, Blender Max, now available in Brazil. You will have that respect session with the most intense and true flavors ever made. If it’s about being the best, only ZOMO!    
            </span></p>
            </div>
            <div class="col-sm-2">
                    <img width="459" height="167"  src="{{ asset('assets/frontend/images/flavors/much_more.png')}}"sizes="(max-width: 459px) 100vw, 459px">
            </div>
    </div>
    @else
            ...
            <div class="product-item">
                @foreach ($data as $val)
                    <div class="product-box">
                        ...
                        <a class="product-title" href="{{ route('frontend.flavors.product.detail',$val->slug)}}">{{ $val->slug }}</a>                
                    </div>
                @endforeach
            </div>
        </div>
