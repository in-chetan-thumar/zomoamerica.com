            ...
            <div class="container">
                ...
                <div class="content-infomation">
                    <div class="contact-form">
                        ...
                        {{ Form::text('email', old('email'), ['class' => '', 'placeholder' => 'Email']) }}
							@error('email')
                        ...
                        {{ Form::text('subject', old('subject'), ['class' => '', 'placeholder' => 'Subject']) }}
							@error('subject')
								<span class="text-danger" style="font-size:15px">
										{{ $message }}
								</span>
							@enderror
                        {{ Form::bsTextArea('', 'message', '', '', ['placeholder' => 'Message', 'class' => '', 'rows' => 10, 'cols' => '30'], [], false) }}
                        <div class="row">
                            {!! NoCaptcha::display() !!}
