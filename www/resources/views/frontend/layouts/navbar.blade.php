        ...
        <nav class="nav-menu" id="navbar">
            <ul class="menu">
                <li class="menu-item menu-dropdown">
                    ...
                    <!--  -->
                    <li class="submenu-item"><a href="{{ route('frontend.aboutus') }}" class="submenu-link">About US</a></li>
                    <li class="submenu-item"><a href="{{ route('frontend.quality') }}" class="submenu-link">Zomo Quality</a></li>
                    <li class="submenu-item"><li class="menu-item"><a href="{{ route('frontend.series') }}" class="submenu-link">Zomo Series</a></li></li>
                        <li class="submenu-item"><a href="{{ route('frontend.authorized.wholesalers') }}" class="submenu-link">Where To Buy</a></li>
                    </ul>
                </li>    
            <li class="menu-item"></li>
                ...
                <li class="menu-item"><a href="{{ route('frontend.product') }}" class="menu-link">Product</a></li>
