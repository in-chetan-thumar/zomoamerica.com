                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="margin-top:70px">
                            ...
                            <div class="wpb_content_element">
                                    <p ><span style="color: #ffffff;">Use of ultrathin paper with vegetable rubber to ensure a standard burn of the product. We have a variety of sizes to meet your needs.</span></p>
                            </div>
                ...
                <div class="vc_custom4">
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="margin-top:70px">
                            ...
                            <div class="vc_text">
                                <p>ALFAFA PAPER PRODUCED IN FRANCE GROWING ECOLOGICAL CERTIFIED ORGANIC AND 100% NATURAL (NO ADDITIVES AND CHLORINE) SLOW BURNING NATURAL GUM ARABICA.</p>
                            </div>

                            <div class="vc_single_image2">
                                <img src="{{ asset('assets/frontend/images/product/see-more.png')}}" width="300" height="94">
                            </div>
                        </div>
                    </div>
                </div>
