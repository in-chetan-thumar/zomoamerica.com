...
<div class="row linha-das-categorias-classic-line">
    ...
    @elseif($category_id === 'World-Line')
        <img src="{{ asset('assets/frontend/images/flavors/zomo_maxLine_banner.png') }}">
    @endif
    <div class="row responsive-banner-content" style="margin-top:-150px;text-align:center;">
            ...
            @elseif($category_id === 'Max-line')
                <div class="elementor-widget-container elementor-motion-effects-element"
                    ...
                    <img width="523"class="image" height="336"
                        src="{{ asset('assets/frontend/images/flavors/zomo_max.png') }}"
        ...
        <div class="col-sm-4" style="letter-spacing: 2px;">
            @if ($category_id === 'Classic-line')
                <p class="descricao-pagina-categorias-classic-line p-sm-2">
            ...
            @elseif($category_id === 'Strong-line')
                <p class="strong-line p-sm-2">Welcome the strength of flavors that will boost your hookah session. The
                    Strong
        ...
        @if ($category_id === 'Max-line')
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <br><br>
                    <p class="inner_paragraph"><span
                            style="color: var( --e-global-color-text ); letter-spacing: 0.4px;">
    ...
    @if ($category_id === 'Classic-line' or $category_id === 'Strong-line' or $category_id === 'World-Line')
</div>
@endif
