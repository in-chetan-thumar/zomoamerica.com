...
<?php $__env->startSection('main'); ?>
    ...
    <body>
        <div class="owl-carousel owl-theme home-banner">
            <div class="item">
                <img class="dastop-images" src=<?php echo e(asset('assets/frontend/images/Banner-main-1.webp')); ?> width="100"
                    height="100" alt="dastop-images">
                <img class="tab-images" src=<?php echo e(asset('assets/frontend/images/banner-images/Banner-main-10241.webp')); ?>

                    width="100" height="100" alt="tab-images">
                <img class="mobile-images" src=<?php echo e(asset('assets/frontend/images/banner-images/Banner-main-6401.webp')); ?>

                    width="100" height="100" alt="mobile-images">
            </div>
            <div class="item">
                <img class="dastop-images" src=<?php echo e(asset('assets/frontend/images/Banner-main-2.webp')); ?> width="100"
                    height="100" alt="dastop-images">
                <img class="tab-images" src=<?php echo e(asset('assets/frontend/images/banner-images/Banner-main-10242.webp')); ?>

                    width="100" height="100" alt="tab-images">
                <img class="mobile-images" src=<?php echo e(asset('assets/frontend/images/banner-images/Banner-main-6402.webp')); ?>

                    width="100" height="100" alt="mobile-images">
            </div>
            <div class="item">
                <img class="dastop-images" src=<?php echo e(asset('assets/frontend/images/Banner-main-3.webp')); ?> width="100"
                    height="100" alt="dastop-images">
                <img class="tab-images" src=<?php echo e(asset('assets/frontend/images/banner-images/Banner-main-10243.webp')); ?>

                    width="100" height="100" alt="tab-images">
                <img class="mobile-images" src=<?php echo e(asset('assets/frontend/images/banner-images/Banner-main-6403.webp')); ?>
            ...
            <div class="container">
                ...
                <div class="owl-carousel owl-theme product-slider-in">
                    <div class="item">
                        <div class="product-box">
                            <a href="single-product.html" class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/product-01.webp')); ?> alt="Product 1"
                    ...
                    <div class="item">
                        <div class="product-box">
                            <a href="single-product.html" class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/product-02.webp')); ?> alt="Product 2"
                                    width="100" height="100">
                            </a>
                    ...
                    <div class="item">
                        <div class="product-box">
                            <a href="single-product.html" class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/product-03.webp')); ?> alt="Product 3"
                                    width="100" height="100">
                            </a>
                ...
                <div class="news-srction-item reveal">
                    <div class="news-section-list">
                        <div class="images-box">
                            ...
                            <img src=<?php echo e(asset('assets/frontend/images/news-01.webp')); ?> alt="News" width="100"
                                height="100">
                        </div>
                    ...
                    <div class="news-section-list">
                        <div class="images-box">
                            ...
                            <img src=<?php echo e(asset('assets/frontend/images/news-02.webp')); ?> alt="News 2" width="100"
                                height="100">
                        </div>
                    ...
                    <div class="news-section-list">
                        <div class="images-box">
                            ...
                            <img src=<?php echo e(asset('assets/frontend/images/news-03.webp')); ?> alt="News 3" width="100"
                                height="100">
                        </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-3 col-md-4 col-6 where-to-buy-item reveal">
                        <div class="where-to-buy-box">
                            <div class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/way-to-buy/wtb-1.webp')); ?> alt="Hookah Shisha"
                                    width="100" height="100">
                            </div>
                            <p>Hookah Shisha</p>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 where-to-buy-item reveal">
                        <div class="where-to-buy-box">
                            <div class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/way-to-buy/wtb-2.webp')); ?> alt="5 Star Hookah"
                                    width="100" height="100">
                            </div>
                            <p>5 Star Hookah</p>
                            <a href="#" class="visit-store">
                    ...
                    <div class="col-lg-3 col-md-4 col-6 where-to-buy-item reveal">
                        <div class="where-to-buy-box">
                            <div class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/way-to-buy/wtb-3.webp')); ?> alt="The Hookah"
                                    width="100" height="100">
                            </div>
                            <p>The Hookah</p>
                            <a href="#" class="visit-store">
                    ...
                    <div class="col-lg-3 col-md-4 col-6 where-to-buy-item reveal">
                        <div class="where-to-buy-box">
                            <div class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/way-to-buy/wtb-4.webp')); ?> alt="Texas Hookah"
                                    width="100" height="100">
                            </div>
                            <p>Texas Hookah</p>
                            <a href="#" class="visit-store">
                    ...
                    <div class="col-lg-3 col-md-4 col-6 where-to-buy-item reveal">
                        <div class="where-to-buy-box">
                            <div class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/way-to-buy/wtb-5.webp')); ?> alt="Hookah John"
                                    width="100" height="100">
                            </div>
                            <p>Hookah John</p>
                            <a href="#" class="visit-store">
                    ...
                    <div class="col-lg-3 col-md-4 col-6 where-to-buy-item reveal">
                        <div class="where-to-buy-box">
                            <div class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/way-to-buy/wtb-6.webp')); ?> alt="Hookah Junkie"
                                    width="100" height="100">
                            </div>
                            <p>Hookah Junkie</p>
                            <a href="#" class="visit-store">
                    ...
                    <div class="col-lg-3 col-md-4 col-6 where-to-buy-item reveal">
                        <div class="where-to-buy-box">
                            <div class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/way-to-buy/wtb-7.webp')); ?> alt="Ultimate Junkie"
                                    width="100" height="100">
                            </div>
                            <p>Ultimate Junkie</p>
                            <a href="#" class="visit-store">
                    ...
                    <div class="col-lg-3 col-md-4 col-6 where-to-buy-item reveal">
                        <div class="where-to-buy-box">
                            <div class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/way-to-buy/wtb-8.webp')); ?> alt="Hookah Heroes"
                                    width="100" height="100">
                            </div>
                            <p>Hookah Heroes</p>
                            <a href="#" class="visit-store">
                    ...
                    <div class="col-lg-3 col-md-4 col-6 where-to-buy-item reveal">
                        <div class="where-to-buy-box">
                            <div class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/way-to-buy/wtb-9.webp')); ?>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 where-to-buy-item reveal">
                        <div class="where-to-buy-box">
                            <div class="images-box">
                                <img src=<?php echo e(asset('assets/frontend/images/way-to-buy/wtb-10.webp')); ?> alt="Hookah Company"
                                    width="100" height="100">
                            </div>
                            <p>Hookah Company</p>
                            <a href="#" class="visit-store">
                ...
                <div class="content-infomation reveal">
                    ...
                    <div class="map-infomation">
                        <div class="image-location">
                            <div class="icon">
                                <img src=<?php echo e(asset('assets/frontend/images/location-icon.webp')); ?> alt="location"
                                    width="100" height="100">
                            </div>
                            <p>Location</p>
                        </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\zomoamerica\www\resources\views/frontend/home.blade.php ENDPATH**/ ?>