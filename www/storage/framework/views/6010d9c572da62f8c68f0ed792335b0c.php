    ...
    <body class="product-page">
            ...
            <div class="news-list">
                ...
                <div class="news-list-wrapper">
                    <div class="news-box ">
                        <div class="images-box">
                            <a href="singles-new.html" class="images">
                                <img src=<?php echo e(asset('assets/frontend/images/new-1.webp')); ?> alt="News 1">
                            </a>
                    ...
                    <div class="news-box ">
                        <div class="images-box">
                            <a href="singles-new.html" class="images">
                                <img src=<?php echo e(asset('assets/frontend/images/new-2.webp')); ?> alt="News 1">
                            </a>
                            <a href="singles-new.html" class="leia-mais">
                                <span>LEIA MAIS</span>
                            </a>
                    ...
                    <div class="news-box reveal">
                        <div class="images-box">
                            <a href="singles-new.html" class="images">
                                <img src=<?php echo e(asset('assets/frontend/images/new-3.webp')); ?> alt="News 1">
                            </a>
                            <a href="singles-new.html" class="leia-mais">
                                <span>LEIA MAIS</span>
                            </a>
        ...
        <div class="history-slider-main reveal">
            <div class="history-slider owl-carousel owl-theme">
                <div class="item">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-slide-01.png')); ?> alt="history-slider">
                </div>
                <div class="item">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-slide-02.png')); ?> alt="history-slider">
                </div>
                <div class="item">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-slide-03.png')); ?> alt="history-slider">
                </div>
                <div class="item">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-slide-04.png')); ?> alt="history-slider">
                </div>
                <div class="item">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-slide-05.webp')); ?> alt="history-slider">
                </div>
            </div>
        </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\zomoamerica\www\resources\views/frontend/news.blade.php ENDPATH**/ ?>