	...
	<div class="product-slider-main">
        <div class="container">
            <div class="product-slider">
                        ...
                        <div class="product-slider-sub-main">
                            <div class="swiper product-slider-sub">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="image-box">
                                            <img class="image" src=<?php echo e(asset('assets/frontend/images/product/product-01.webp')); ?> alt="product-01" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image-box">
                                            <img class="image" src=<?php echo e(asset('assets/frontend/images/product/product-02.webp')); ?> alt="product-02" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper thumb-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="image-box">
                                            <img src=<?php echo e(asset('assets/frontend/images/product/product-01.webp')); ?> alt="product-01" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image-box">
                                            <img src=<?php echo e(asset('assets/frontend/images/product/product-02.webp')); ?> alt="product-02" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="icon">
                    <a class="left-arrow arrow-icon" href="#"><img src=<?php echo e(asset('assets/frontend/images/icons/slider-icon-left.webp')); ?> alt="left-icon"></a>
                    <a class="right-arrow arrow-icon" href="#"><img src=<?php echo e(asset('assets/frontend/images/icons/slider-icon-right.webp')); ?> alt="left-icon"></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\zomoamerica\www\resources\views/frontend/product.blade.php ENDPATH**/ ?>