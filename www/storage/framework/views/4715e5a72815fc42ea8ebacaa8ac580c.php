   ...
   <div class="btcm">
    ...
    <div>
        <div class="container">
            <div class="banner-image">
                <img src=<?php echo e(asset('assets/frontend/images/about-us/banner.webp')); ?> alt="banner-image">
            </div>
        </div>
    </div>
    <div>
    ...
    <div class="d-flex">
        <div class="about-history-main">
            <div class="logo-img">
                <img src=<?php echo e(asset('assets/frontend/images/about-us/zomo.webp')); ?> alt="zomo">
            </div>
                ...
                <div class="about-item-main reveal">
                    <div class="about-item">
                        <div class="image" data-bs-toggle="modal" data-bs-target="#history-img01">
                            <img src=<?php echo e(asset('assets/frontend/images/about-us/history-01.png')); ?> alt="history-01">
                        </div>
                ...
                <div class="about-item-main reveal">
                    <div class="about-item">
                        <div class="image" data-bs-toggle="modal" data-bs-target="#history-img02">
                            <img src=<?php echo e(asset('assets/frontend/images/about-us/history-02.webp')); ?> alt="history-02">
                        </div>
                        <div class="content-details">
                ...
                <div class="about-item-main reveal">
                    <div class="about-item">
                        <div class="image" data-bs-toggle="modal" data-bs-target="#history-img03">
                            <img src=<?php echo e(asset('assets/frontend/images/about-us/history-03.webp')); ?> alt="history-03">
                        </div>
                        <div class="content-details">
                ...
                <div class="about-item-main reveal">
                    <div class="about-item">
                        <div class="image" data-bs-toggle="modal" data-bs-target="#history-img04">
                            <img src=<?php echo e(asset('assets/frontend/images/about-us/history-04.webp')); ?> alt="history-04">
                        </div>
                        <div class="content-details">
                ...
                <div class="about-item-main reveal">
                    <div class="about-item">
                        <div class="image" data-bs-toggle="modal" data-bs-target="#history-img05">
                            <img src=<?php echo e(asset('assets/frontend/images/about-us/history-05.webp')); ?> alt="history-05">
                        </div>
                        <div class="content-details">
                ...
                <div class="about-item-main reveal">
                    <div class="about-item">
                        <div class="image" data-bs-toggle="modal" data-bs-target="#history-img06">
                            <img src=<?php echo e(asset('assets/frontend/images/about-us/history-06.webp')); ?> alt="history-06">
                        </div>
                        <div class="content-details">
                ...
                <div class="about-item-main reveal">
                    <div class="about-item">
                        <div class="image" data-bs-toggle="modal" data-bs-target="#history-img07">
                            <img src=<?php echo e(asset('assets/frontend/images/about-us/history-07.webp')); ?> alt="history-07">
                        </div>
                        <div class="content-details">
    ...
    <div class="history-slider-main reveal">
        <div class="history-slider owl-carousel owl-theme">
            <div class="item">
                <img src=<?php echo e(asset('assets/frontend/images/about-us/history-01.png')); ?> alt="history-slider">
            </div>
            <div class="item">
                <img src=<?php echo e(asset('assets/frontend/images/about-us/history-slide-02.png')); ?> alt="history-slider">
            </div>
            <div class="item">
                <img src=<?php echo e(asset('assets/frontend/images/about-us/history-03.webp')); ?> alt="history-slider">
            </div>
            <div class="item">
                <img src=<?php echo e(asset('assets/frontend/images/about-us/history-04.webp')); ?> alt="history-slider">
            </div>
            <div class="item">
                <img src=<?php echo e(asset('assets/frontend/images/about-us/history-05.webp')); ?> alt="history-slider">
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-01.png')); ?> alt="history">
                </div>
                <div class="modal-footer">
                    <p>EVERYTHING HAS A BEGINNING!</p>
                    <button type="button" class="close-icon" data-bs-dismiss="modal" aria-label="Close"><img
                            src=<?php echo e(asset('assets/frontend/images/icons/close-icon.webp')); ?> alt="close"></button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade history" id="history-img02" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-02.webp')); ?> alt="history">
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade history" id="history-img03" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-03.webp')); ?> alt="history">
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade history" id="history-img04" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-04.webp')); ?> alt="history">
                </div>
                <div class="modal-footer">
                    <p>2018 WAS CRAZY</p>
                    <button type="button" class="close-icon" data-bs-dismiss="modal" aria-label="Close"><img
    ...
    <div class="modal fade history" id="history-img05" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-05.webp')); ?> alt="history">
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade history" id="history-img06" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-06.webp')); ?> alt="history">
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade history" id="history-img07" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <img src=<?php echo e(asset('assets/frontend/images/about-us/history-07.webp')); ?> alt="history">
                </div>
                <div class="modal-footer">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\zomoamerica\www\resources\views/frontend/aboutus.blade.php ENDPATH**/ ?>