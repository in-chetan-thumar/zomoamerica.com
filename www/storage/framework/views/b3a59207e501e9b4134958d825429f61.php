        ...
        <div class="footer-item">
            <div class="footer-list">
                <a href="#" class="footer-logo">
                    <img src=<?php echo e(asset('assets/frontend/images/logo-footer.webp')); ?> alt="footer logo" width="100"
                        height="100">
                </a>
                <div class="nav-footer-link">
                    <a href="<?php echo e(route('frontend.product')); ?>">PRODUCTS</a>
                    <a href="<?php echo e(route('frontend.news')); ?>">News</a>
                    <a href="<?php echo e(route('frontend.contact')); ?>">contact us</a>
                    <a href="<?php echo e(route('frontend.wholesale')); ?>">WHOLESALE</a>
                    <a href="<?php echo e(route('frontend.faqs')); ?>">FAQS</a>
                    <a href="<?php echo e(route('frontend.quality')); ?>">Zomo Quality</a>
                    <a href="<?php echo e(route('frontend.authorized.wholesalers')); ?>">Where To Buy</a>
                </div>
            </div>
...
<!-- <div class="jquery-modal blocker current">
        <div id="bouncer_modal" class="modal_bouncer">
            <form name="AgeVerForm" id="AgeVerForm">
                <div class="model_logo">
                    <img src=<?php echo e(asset('assets/frontend/images/logo.webp')); ?> alt="model" width="100" height="100">
                </div>
 ...
 -->
<?php /**PATH D:\OSPanel\domains\zomoamerica\www\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>